...
window.addEventListener('DOMContentLoaded', function() {
    ...
    //Используем классы для карточку

    class MenuCard {
        //Rest параметры не поддерживают значений по умолчанию...
        constructor(src, alt, title, descr, price, parentSelector, ...classes) {
            //Rest оператор создает по-любому пустой массив []
            this.src = src;
            this.alt = alt;
            this.title = title;
            this.descr = descr;
            this.price = price;
            this.classes = classes;//С ним надо работать как с массивами;
    ...
    new MenuCard(
        ...
        "elite",
        'Меню “Премиум”',
        'В меню “Премиум” мы используем не только красивый дизайн упаковки, но и качественное исполнение блюд. Красная рыба, морепродукты, фрукты - ресторанное меню без похода в ресторан!fdhgdhdgjhdfjdjdfhdfhdfhg',
        14,
        '.menu .container',
        'menu__item'
    ).render();
